# KoproGo K3s - Integration Environment
module "k3s" {
...
variable "k3s_agent_count"      { type = number; default = 0 }
...
output "master_ip"    { value = module.k3s.master_ip_public }
output "cluster_info" { value = module.k3s.cluster_info }
