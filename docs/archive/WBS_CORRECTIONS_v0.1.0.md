...
> (cf. son §Supersession ligne 7). Variante du `WBS_BUGFIX_UI_v0.1.0.md` —
> mêmes correctifs implémentés ou vérifiés ALREADY-FIXED. Conservé comme
> contexte historique 2026-04-01 ; **plus une vérité courante**.
