> ⚠️ **Supersédé** par [`WBS_GO_LIVE_v0.1.0.md`](WBS_GO_LIVE_v0.1.0.md)
> (cf. son §Supersession ligne 7). Les correctifs UI listés ici ont été
> implémentés ou vérifiés ALREADY-FIXED (WP-B1 PR #536, WP-FE2 PR #547).
> Conservé comme contexte historique 2026-04-01 ; **plus une vérité
> courante**.
