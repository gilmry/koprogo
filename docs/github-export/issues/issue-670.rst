=====================================================================
Issue #670: [Story B6] SyndicResponseForm + SlaBadge atomique (FR-B6)
=====================================================================
...
:Created: 2026-07-26
:Updated: 2026-07-26
:URL: `View on GitHub <https://github.com/gilmry/koprogo/issues/670>`_
...
::
   ...
   Composant frontend `SyndicResponseForm` + badge SLA atomique pour le suivi de réponse syndic.
