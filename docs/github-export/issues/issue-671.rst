================================================================================================
Issue #671: [Story B7] TechnicalSpec full flow (Create+Detail+Signature+VersionTimeline) (FR-B7)
================================================================================================
...
:Created: 2026-07-26
:Updated: 2026-07-26
:URL: `View on GitHub <https://github.com/gilmry/koprogo/issues/671>`_
...
::
   ...
   Flow frontend complet du cahier des charges technique : création, détail, signature, timeline de versions.
