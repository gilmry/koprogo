=========================================================================
Issue #666: [Story B1] RoleAssignmentForm + List admin sous-rôles (FR-B1)
=========================================================================
...
:Created: 2026-07-26
:Updated: 2026-07-26
:URL: `View on GitHub <https://github.com/gilmry/koprogo/issues/666>`_
...
::
   ...
   Composant frontend `RoleAssignmentForm` + liste admin pour la gestion des sous-rôles métier (accountant.encodeur/emetteur, community.moderator...).
