...
Auto-generated documentation mirror for ``backend/src/infrastructure/web/handlers/stats_handlers.rs``.
...
**Location**: ``backend/src/infrastructure/web/handlers/stats_handlers.rs``
