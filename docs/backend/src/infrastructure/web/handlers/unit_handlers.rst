...
Auto-generated documentation mirror for ``backend/src/infrastructure/web/handlers/unit_handlers.rs``.
...
**Location**: ``backend/src/infrastructure/web/handlers/unit_handlers.rs``
