...
Auto-generated documentation mirror for ``backend/src/application/ports/meeting_repository.rs``.
...
**Location**: ``backend/src/application/ports/meeting_repository.rs``
