...
**Un marché fragmenté** :
  200,000 copropriétés qui négocient chacune dans leur coin
...
**Belgique** : 200,000 copropriétés
**France** : 750,000 copropriétés
**Espagne** : 1,100,000 copropriétés
...
Sur ``https://koprogo.com/transparency`` (accessible sans login) :

* Nombre de participants actifs
* Coûts infrastructure réels (serveurs, stockage)
* Prix coûtant vs Prix facturé
* Surplus généré (€ et %)
...
* **Hébergement** : OVH France (Gravelines, 60g CO₂/kWh)

**PropTech 2.0** (modules optionnels) :

* **AI Assistant** : OVH AI Endpoints @ Gravelines (+2€/mois)
* **Blockchain Voting** : Polygon RPC (+1€/mois)
