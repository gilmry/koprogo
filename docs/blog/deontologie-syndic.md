---
title: "Code de déontologie du syndic : les 28 règles essentielles"
description: "Le Code de déontologie IPI impose 28 règles aux syndics professionnels belges. Conflits d'intérêts, anti-blanchiment, comptes séparés : le guide complet."
category: "syndic"
tags:
  [
    "déontologie",
...
legalRefs: ["Code de déontologie IPI", "Loi 18/09/2017"]
---

```{post} 2025-04-20
:tags: déontologie, IPI, conflit d'intérêts, anti-blanchiment
:category: syndic
:language: fr
```
