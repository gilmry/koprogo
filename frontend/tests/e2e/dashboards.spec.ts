...
test.describe("Syndic Dashboard", () => {
  ...
  test("should display syndic dashboard with correct sections", async ({
    page,
  }) => {
    // Vérifier le titre
  ...
  test("should have navigation menu with syndic-specific items", async ({
    page,
  }) => {
...
test.describe("Accountant Dashboard", () => {
  ...
  test("should display accountant dashboard with financial focus", async ({
    page,
  }) => {
...
test.describe("Owner Dashboard", () => {
  ...
  test("should display owner dashboard with personal information", async ({
    page,
  }) => {
...
test.describe("SuperAdmin Dashboard", () => {
  ...
  test("should display admin dashboard with platform overview", async ({
    page,
  }) => {
    await expect(page.locator("text=Dashboard Administrateur")).toBeVisible();
    await expect(
      page.locator("text=Vue d'ensemble de la plateforme"),
    ).toBeVisible();
  });
...
test.describe("Navigation Between Pages", () => {
  test("should navigate between different sections smoothly", async ({
    page,
  }) => {
    // Login
    await page.goto("/login");
