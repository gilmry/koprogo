...
test.describe('Authentication Flow', () => {
  ...
  test('should show error for invalid credentials', async ({ page }) => {
    ...
    await expect(page.locator('text=/Email ou mot de passe incorrect|Une erreur est survenue/')).toBeVisible();
  });
  ...
  test('should logout successfully', async ({ page }) => {
    ...
    const token = await page.evaluate(() => localStorage.getItem('koprogo_token'));
