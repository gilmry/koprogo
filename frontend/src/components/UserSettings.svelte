  ...
  $: settingsSections = [
    {
      ...
      badge: "amber",
      title: $_("settings.profile.title"),
      description: $_("settings.profile.description"),
      label: $_("settings.profile.label"),
    },
    {
      ...
      badge: "blue",
      title: $_("settings.notifications.title"),
      description: $_("settings.notifications.description"),
    ...
    },
    {
      ...
      badge: "green",
      title: $_("settings.gdpr.title"),
      description: $_("settings.gdpr.description"),
      label: $_("settings.gdpr.label"),
    },
  ];
</script>
...
<div class="space-y-6">
  {#if user}
    ...
    <div
      class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 flex items-center gap-4"
    >
      <div
    ...
    {#each settingsSections as section}
      <a
        ...
        class="block bg-white rounded-lg border {section.color.split(
          ' ',
        )[1]} hover:shadow-md transition-shadow p-5 group"
      >
        <div class="flex items-start gap-4">
          <div
            class="shrink-0 w-10 h-10 rounded-lg {section.color.split(
              ' ',
            )[0]} flex items-center justify-center"
          >
            <svg
              class="w-5 h-5 {section.color.split(' ')[2]}"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
