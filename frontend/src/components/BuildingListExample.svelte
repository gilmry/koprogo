  ...
  {#if showForm}
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label
            for="building-create-postal-code"
            class="block text-sm font-medium text-gray-700 mb-1"
          >
        ...
        <div>
          <label
            for="building-create-total-units"
            class="block text-sm font-medium text-gray-700 mb-1"
          >
        ...
        <div>
          <label
            for="building-create-construction-year"
            class="block text-sm font-medium text-gray-700 mb-1"
          >
