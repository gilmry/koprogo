...
<div class="bg-white shadow rounded-lg p-6" data-testid="ticket-statistics">
  ...
  {#if loading}
    <div class="text-center py-8 text-gray-500" data-testid="loading-spinner">
      {$_("tickets.loadingStatistics")}
    </div>
  {:else if stats}
    <dl class="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div class="bg-blue-50 rounded-lg p-4" data-testid="ticket-stat-open">
        <dt class="text-sm font-medium text-blue-700 mb-1">
          {$_("tickets.statusOpen")}
        </dt>
      ...
      <div
        ...
        data-testid="ticket-stat-in-progress"
      >
        <dt class="text-sm font-medium text-yellow-700 mb-1">
          {$_("tickets.statusInProgress")}
        </dt>
      ...
      <div
        ...
        data-testid="ticket-stat-resolved"
      >
        <dt class="text-sm font-medium text-green-700 mb-1">
          {$_("tickets.statusResolved")}
        </dt>
      ...
      <div
        ...
        data-testid="ticket-stat-assigned"
      >
        <dt class="text-sm font-medium text-purple-700 mb-1">
          {$_("tickets.statusAssigned")}
        </dt>
      ...
      <div class="bg-red-50 rounded-lg p-4" data-testid="ticket-stat-overdue">
        <dt class="text-sm font-medium text-red-700 mb-1">
          ⚠️ {$_("tickets.overdue")}
        </dt>
      ...
      <div
        ...
        data-testid="ticket-stat-avg-resolution"
      >
