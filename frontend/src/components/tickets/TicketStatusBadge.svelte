<script lang="ts">
  ...
  > = {
    [TicketStatus.Open]: {
      bg: "bg-blue-100",
      text: "text-blue-800",
      key: "tickets.statuses.open",
    },
    [TicketStatus.InProgress]: {
      bg: "bg-yellow-100",
      text: "text-yellow-800",
      key: "tickets.statuses.inProgress",
    },
    [TicketStatus.Resolved]: {
      bg: "bg-green-100",
      text: "text-green-800",
      key: "tickets.statuses.resolved",
    },
    [TicketStatus.Closed]: {
      bg: "bg-gray-100",
      text: "text-gray-800",
      key: "tickets.statuses.closed",
    },
    [TicketStatus.Cancelled]: {
      bg: "bg-red-100",
      text: "text-red-800",
      key: "tickets.statuses.cancelled",
    },
  };

  let config = $derived(
    statusColors[status] || statusColors[TicketStatus.Open],
  );
</script>
