<script lang="ts">
  ...
  type NatureDeLot =
    "Apartment" | "Parking" | "Cellar" | "Commercial" | "Other";
        ...
        >
          ...
          <div>
            ...
            ><select
              ...
              ><option value="Cellar">{$_("units.cellar")}</option><option
                value="Commercial">{$_("units.commercial")}</option
              ><option value="Other">{$_("units.other")}</option></select
            >
          </div>
          <div>
            <label
          ...
          <div class="flex gap-2 pt-4">
            <Button type="submit" variant="primary" disabled={loading}
              >{loading ? $_("common.updating") : $_("common.save")}</Button
