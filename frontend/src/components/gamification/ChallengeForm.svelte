...
>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div class="md:col-span-2">
      <label for="ch-title" class="block text-sm font-medium text-gray-700"
        >{$_("gamification.title")} *</label
      >
      <input
        id="ch-title"
        type="text"
    ...
    <div class="md:col-span-2">
      <label for="ch-desc" class="block text-sm font-medium text-gray-700"
    ...
    <div>
      <label for="ch-type" class="block text-sm font-medium text-gray-700"
    ...
    <div>
      <label for="ch-icon" class="block text-sm font-medium text-gray-700"
    ...
    <div>
      <label for="ch-start" class="block text-sm font-medium text-gray-700"
    ...
    <div>
      <label for="ch-end" class="block text-sm font-medium text-gray-700"
    ...
    <div>
      <label for="ch-metric" class="block text-sm font-medium text-gray-700"
    ...
    <div>
      <label for="ch-target" class="block text-sm font-medium text-gray-700"
    ...
    <div>
      <label for="ch-reward" class="block text-sm font-medium text-gray-700"
