...
pub mod board_alert_repository_impl;
...
pub mod gdpr_art30_repository_impl;
pub mod gdpr_repository_impl;
pub mod individual_member_repository_impl;
pub mod iot_repository_impl;
pub mod journal_entry_repository_impl;
pub mod lien_notaire_repository_impl;
...
pub mod portfolio_repository_impl;
...
pub mod role_delegation_repository_impl;
pub mod security_incident_repository_impl;
pub mod service_provider_repository_impl;
pub mod shared_object_repository_impl;
pub mod skill_repository_impl;
pub mod stats_repository_impl;
pub mod syndic_response_repository_impl;
pub mod technical_inspection_repository_impl;
pub mod technical_spec_repository_impl;
...
pub use board_alert_repository_impl::PostgresBoardAlertRepository;
...
pub use fund_repository_impl::PostgresFundRepository;
pub use gdpr_art30_repository_impl::PostgresGdprArt30Repository;
pub use gdpr_repository_impl::PostgresGdprRepository;
pub use individual_member_repository_impl::PostgresIndividualMemberRepository;
pub use iot_repository_impl::PostgresIoTRepository;
pub use journal_entry_repository_impl::PostgresJournalEntryRepository;
pub use lien_notaire_repository_impl::PostgresLienNotaireRepository;
pub use local_exchange_repository_impl::PostgresLocalExchangeRepository;
pub use magic_link_repository_impl::PostgresMagicLinkRepository;
pub use mandate_repository_impl::PostgresMandateRepository;
pub use meeting_repository_impl::PostgresMeetingRepository;
pub use module_registry_impl::PostgresModuleRegistry;
...
pub use portfolio_repository_impl::PostgresPortfolioRepository;
...
pub use role_delegation_repository_impl::PostgresRoleDelegationRepository;
pub use security_incident_repository_impl::PostgresSecurityIncidentRepository;
pub use service_provider_repository_impl::PostgresServiceProviderRepository;
...
pub use stats_repository_impl::PostgresStatsRepository;
pub use syndic_response_repository_impl::PostgresSyndicResponseRepository;
pub use technical_inspection_repository_impl::PostgresTechnicalInspectionRepository;
pub use technical_spec_repository_impl::PostgresTechnicalSpecRepository;
