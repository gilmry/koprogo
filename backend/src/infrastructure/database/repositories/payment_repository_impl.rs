...
impl PaymentRepository for PostgresPaymentRepository {
    async fn create(&self, payment: &Payment) -> Result<Payment, String> {
        ...
        let row = sqlx::query!(
            ...
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8::transaction_status, $9::payment_method_type,
    ...
    async fn find_by_status(
        ...
        let rows = sqlx::query!(
            ...
            SELECT id, organization_id, building_id, owner_id, expense_id,
                   ...
                   created_at, updated_at
            FROM payments
            WHERE organization_id = $1 AND status = $2::transaction_status
            ORDER BY created_at DESC
            "#,
            organization_id,
            status_str
    ...
    async fn find_by_building_and_status(
        ...
        let rows = sqlx::query!(
            ...
            SELECT id, organization_id, building_id, owner_id, expense_id,
                   ...
                   created_at, updated_at
            FROM payments
            WHERE building_id = $1 AND status = $2::transaction_status
            ORDER BY created_at DESC
            "#,
            building_id,
            status_str
    ...
    async fn update(&self, payment: &Payment) -> Result<Payment, String> {
        ...
        let row = sqlx::query!(
            ...
            SET organization_id = $2,
                ...
                amount_cents = $6,
                currency = $7,
                status = $8::transaction_status,
                payment_method_type = $9::payment_method_type,
