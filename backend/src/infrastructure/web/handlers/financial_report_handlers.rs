...
pub async fn generate_balance_sheet(
        ...
        .await
    {
        Ok(report) => {
            ...
            .with_metadata("report_type", "balance_sheet")
            .log();
...
pub async fn generate_income_statement(
        ...
        .await
    {
        Ok(report) => {
            ...
            .with_metadata("report_type", "income_statement")
            .with_metadata("period_start", &query.period_start)
            .with_metadata("period_end", &query.period_end)
            .log();
