...
pub fn configure_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api/v1")
            ...
            // Payment Reminders (Recovery Workflow)
            .service(create_reminder)
            .service(get_reminder)
            .service(list_by_expense)
            .service(list_by_owner)
            .service(list_active_by_owner)
            .service(list_by_organization)
            .service(mark_as_sent)
            .service(mark_as_opened)
            .service(mark_as_paid)
            .service(cancel_reminder)
            .service(escalate_reminder)
            .service(add_tracking_number)
            .service(get_recovery_stats)
            .service(find_overdue_without_reminders)
            .service(bulk_create_reminders)
