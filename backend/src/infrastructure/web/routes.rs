...
pub fn configure_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api/v1")
            ...
            // Owners
            // IMPORTANT: /owners/me MUST be registered before /owners/{id}
            // because {id} would catch "me" as a path parameter
            .service(get_my_owner)
            ...
            .service(schedule_second_convocation) // POST /convocations/second (must come before /convocations/{id})
            ...
            .service(get_overdue_tickets_org) // /tickets/overdue (org-level)
            .service(list_tickets_by_status)
            .service(get_ticket_statistics) // /buildings/{id}/tickets/statistics
            .service(get_overdue_tickets) // /buildings/{id}/tickets/overdue
            ...
            // Specific routes MUST come before parameterized /notifications/{id}
            ...
            // Specific routes MUST come before parameterized /payments/{id}
            .service(create_payment)
            .service(get_payment_by_stripe_intent)
            .service(list_payments_by_status)
            .service(list_pending_payments)
            ...
            // Specific routes MUST come before parameterized /shared-objects/{id}
            ...
            // Specific routes MUST come before parameterized /resource-bookings/{id}
