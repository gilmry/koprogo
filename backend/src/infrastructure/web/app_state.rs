use crate::application::use_cases::{
    ...
    ChallengeUseCases, ChargeDistributionUseCases, ConvocationUseCases, DocumentUseCases,
    EtatDateUseCases, ExpenseUseCases, FinancialReportUseCases, GamificationStatsUseCases,
    GdprUseCases, LocalExchangeUseCases, MeetingUseCases, NoticeUseCases, NotificationUseCases,
    OwnerUseCases, PaymentMethodUseCases, PaymentReminderUseCases, PaymentUseCases,
    PcnUseCases, QuoteUseCases, ResolutionUseCases, ResourceBookingUseCases,
