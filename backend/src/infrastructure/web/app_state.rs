...
use crate::application::use_cases::{
    ...
    IndividualMemberUseCases,
    IoTUseCases, JournalEntryUseCases, LinkyUseCases, LocalExchangeUseCases, MeetingUseCases,
    NoticeUseCases, NotificationUseCases, OwnerContributionUseCases, OwnerUseCases,
    ...
    ServiceProviderUseCases, SharedObjectUseCases, SkillUseCases,
...
pub struct AppState {
    ...
    pub two_factor_use_cases: Arc<TwoFactorUseCases>,
    ...
    pub technical_inspection_use_cases: Arc<TechnicalInspectionUseCases>,
    pub work_report_use_cases: Arc<WorkReportUseCases>,
    pub document_use_cases: Arc<DocumentUseCases>,
    pub energy_campaign_use_cases: Arc<EnergyCampaignUseCases>,
    pub energy_bill_upload_use_cases: Arc<EnergyBillUploadUseCases>,
    ...
    pub gdpr_art30_use_cases: Arc<GdprArt30UseCases>,
    pub gdpr_use_cases: Arc<GdprUseCases>,
    pub iot_use_cases: Arc<IoTUseCases>,
    ...
    pub security_incident_use_cases: Arc<SecurityIncidentUseCases>,
    pub service_provider_use_cases: Arc<ServiceProviderUseCases>,
    pub individual_member_use_cases: Arc<IndividualMemberUseCases>,
...
impl AppState {
    ...
    pub fn new(
        ...
        two_factor_use_cases: TwoFactorUseCases,
        ...
        technical_inspection_use_cases: TechnicalInspectionUseCases,
        work_report_use_cases: WorkReportUseCases,
        document_use_cases: DocumentUseCases,
        energy_campaign_use_cases: EnergyCampaignUseCases,
        energy_bill_upload_use_cases: EnergyBillUploadUseCases,
        etat_date_use_cases: EtatDateUseCases,
        pcn_use_cases: PcnUseCases,
        payment_reminder_use_cases: PaymentReminderUseCases,
        gdpr_art30_use_cases: GdprArt30UseCases,
        gdpr_use_cases: GdprUseCases,
        iot_use_cases: IoTUseCases,
        ...
        security_incident_use_cases: SecurityIncidentUseCases,
        service_provider_use_cases: ServiceProviderUseCases,
        individual_member_use_cases: IndividualMemberUseCases,
        ...
        Self {
            ...
            two_factor_use_cases: Arc::new(two_factor_use_cases),
            ...
            technical_inspection_use_cases: Arc::new(technical_inspection_use_cases),
            work_report_use_cases: Arc::new(work_report_use_cases),
            document_use_cases: Arc::new(document_use_cases),
            energy_campaign_use_cases: Arc::new(energy_campaign_use_cases),
            energy_bill_upload_use_cases: Arc::new(energy_bill_upload_use_cases),
            ...
            gdpr_art30_use_cases: Arc::new(gdpr_art30_use_cases),
            gdpr_use_cases: Arc::new(gdpr_use_cases),
            iot_use_cases: Arc::new(iot_use_cases),
            ...
            security_incident_use_cases: Arc::new(security_incident_use_cases),
            service_provider_use_cases: Arc::new(service_provider_use_cases),
            individual_member_use_cases: Arc::new(individual_member_use_cases),
