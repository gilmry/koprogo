use crate::application::use_cases::{
    ...
    GamificationStatsUseCases, GdprUseCases, IoTUseCases, JournalEntryUseCases, LinkyUseCases,
    ...
    PaymentUseCases, PcnUseCases, PollUseCases, QuoteUseCases, ResolutionUseCases,
    ResourceBookingUseCases, SharedObjectUseCases, SkillUseCases, TechnicalInspectionUseCases,
    TicketUseCases, TwoFactorUseCases, UnitOwnerUseCases, UnitUseCases, WorkReportUseCases,
};
