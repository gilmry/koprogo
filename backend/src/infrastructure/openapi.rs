...
#[openapi(
    ...
    paths(
        ...
        // Payments
        // Dépenses et factures — 17 routes entrées au contrat le 2026-09-06 (#765).
        // Leur absence est ce qui a laissé `line_items` dériver sans que rien ne
        // le signale : sans contrat, le frontend écrit ses types à la main.
        crate::infrastructure::web::handlers::expense_handlers::create_expense,
        crate::infrastructure::web::handlers::expense_handlers::get_expense,
        crate::infrastructure::web::handlers::expense_handlers::list_expenses,
        crate::infrastructure::web::handlers::expense_handlers::list_expenses_by_building,
        crate::infrastructure::web::handlers::expense_handlers::mark_expense_paid,
        crate::infrastructure::web::handlers::expense_handlers::mark_expense_overdue,
        crate::infrastructure::web::handlers::expense_handlers::cancel_expense,
        crate::infrastructure::web::handlers::expense_handlers::reactivate_expense,
        crate::infrastructure::web::handlers::expense_handlers::unpay_expense,
        crate::infrastructure::web::handlers::expense_handlers::create_invoice_draft,
        crate::infrastructure::web::handlers::expense_handlers::update_invoice_draft,
        crate::infrastructure::web::handlers::expense_handlers::submit_invoice_for_approval,
        crate::infrastructure::web::handlers::expense_handlers::approve_invoice,
        crate::infrastructure::web::handlers::expense_handlers::reject_invoice,
        crate::infrastructure::web::handlers::expense_handlers::get_pending_invoices,
        crate::infrastructure::web::handlers::expense_handlers::get_invoice,
        crate::infrastructure::web::handlers::expense_handlers::export_work_quote_pdf,
    ...
    components(schemas(
        ...
        crate::application::dto::expense_dto::CreateExpenseDto,
        crate::application::dto::expense_dto::ExpenseResponseDto,
        crate::application::dto::expense_dto::CreateInvoiceDraftDto,
        crate::application::dto::expense_dto::UpdateInvoiceDraftDto,
        crate::application::dto::expense_dto::SubmitForApprovalDto,
        crate::application::dto::expense_dto::ApproveInvoiceDto,
        crate::application::dto::expense_dto::RejectInvoiceDto,
