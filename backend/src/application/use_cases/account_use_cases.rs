...
impl AccountUseCases {
    ...
    pub async fn create_account(
        ...
        let account = Account::new(code, label, parent_code, account_type, direct_use, organization_id)?;
    ...
    pub async fn update_account(
        ...
        if let Some(Some(ref new_parent)) = parent_code {
            if !self
                ...
                .await?
            {
                return Err(format!("Parent account code '{}' does not exist", new_parent));
            }
        }
    ...
    pub async fn seed_belgian_pcmn(&self, organization_id: Uuid) -> Result<i64, String> {
        ...
        let existing_count = self.repository.count_by_organization(organization_id).await?;
        if existing_count > 0 {
            return Err(format!(
...
fn get_belgian_pcmn_seed_data() -> Vec<(&'static str, &'static str, Option<&'static str>, AccountType, bool)> {
    vec![
        // ====================================================================
        // CLASS 1: LIABILITIES (Capital, Reserves, Provisions)
        // ====================================================================
        ("1", "Fonds propres, provisions pour risques et charges", None, AccountType::Liability, false),
        ("10", "Capital", Some("1"), AccountType::Liability, false),
        ("100", "Capital souscrit", Some("10"), AccountType::Liability, true),
        ("13", "Réserves", Some("1"), AccountType::Liability, false),
        ("130", "Réserve légale", Some("13"), AccountType::Liability, true),
        ("131", "Réserves disponibles", Some("13"), AccountType::Liability, true),
        ("14", "Provisions pour risques et charges", Some("1"), AccountType::Liability, true),

        // ====================================================================
        // CLASS 2-3: FIXED ASSETS & INVENTORY (minimal for property mgmt)
        // ====================================================================
        ("2", "Actifs immobilisés", None, AccountType::Asset, false),
        ("22", "Terrains et constructions", Some("2"), AccountType::Asset, false),
        ...
        // ====================================================================
        ("4", "Créances et dettes à un an au plus", None, AccountType::Asset, false),

        // Owners receivables (appels de fonds)
        ("40", "Créances commerciales", Some("4"), AccountType::Asset, false),
        ("400", "Copropriétaires - Appels de fonds", Some("40"), AccountType::Asset, true),
        ("401", "Copropriétaires - Charges courantes", Some("40"), AccountType::Asset, true),
        ("402", "Copropriétaires - Travaux extraordinaires", Some("40"), AccountType::Asset, true),
        ("409", "Réductions de valeur actées (provisions)", Some("40"), AccountType::Asset, true),

        // Suppliers payables
        ("44", "Dettes commerciales", Some("4"), AccountType::Liability, false),
        ("440", "Fournisseurs", Some("44"), AccountType::Liability, true),
        ("441", "Effets à payer", Some("44"), AccountType::Liability, true),

        // VAT
        ("45", "Dettes fiscales, salariales et sociales", Some("4"), AccountType::Liability, false),
        ("451", "TVA à payer", Some("45"), AccountType::Liability, true),
        ("411", "TVA récupérable", Some("4"), AccountType::Asset, true),

        // Other receivables/payables
        ("46", "Acomptes reçus", Some("4"), AccountType::Liability, true),
        ("47", "Dettes diverses", Some("4"), AccountType::Liability, true),

        // ====================================================================
        // CLASS 5: BANK & CASH
        // ====================================================================
        ("5", "Placements de trésorerie et valeurs disponibles", None, AccountType::Asset, false),
        ("55", "Établissements de crédit", Some("5"), AccountType::Asset, false),
        ("550", "Compte courant bancaire", Some("55"), AccountType::Asset, true),
        ("551", "Compte épargne", Some("55"), AccountType::Asset, true),
        ...
        ("60", "Approvisionnements et marchandises", Some("6"), AccountType::Expense, false),
        ("604", "Achats de fournitures", Some("60"), AccountType::Expense, false),
        ("604001", "Électricité", Some("604"), AccountType::Expense, true),
        ("604002", "Eau", Some("604"), AccountType::Expense, true),
        ("604003", "Gaz / Chauffage", Some("604"), AccountType::Expense, true),
        ("604004", "Mazout", Some("604"), AccountType::Expense, true),

        // Class 61: Services and goods
        ("61", "Services et biens divers", Some("6"), AccountType::Expense, false),

        ("610", "Loyers et charges locatives", Some("61"), AccountType::Expense, false),
        ("610001", "Loyer local syndic", Some("610"), AccountType::Expense, true),
        ("610002", "Charges locatives", Some("610"), AccountType::Expense, true),

        ("611", "Entretien et réparations", Some("61"), AccountType::Expense, false),
        ("611001", "Entretien bâtiment", Some("611"), AccountType::Expense, true),
        ("611002", "Entretien ascenseur", Some("611"), AccountType::Expense, true),
        ("611003", "Entretien chauffage", Some("611"), AccountType::Expense, true),
        ("611004", "Entretien espaces verts", Some("611"), AccountType::Expense, true),
        ("611005", "Nettoyage parties communes", Some("611"), AccountType::Expense, true),

        ("612", "Fournitures faites à l'entreprise", Some("61"), AccountType::Expense, false),
        ("612001", "Petit matériel", Some("612"), AccountType::Expense, true),
        ("612002", "Produits d'entretien", Some("612"), AccountType::Expense, true),

        ("613", "Rétributions de tiers", Some("61"), AccountType::Expense, false),
        ("613001", "Honoraires syndic", Some("613"), AccountType::Expense, true),
        ("613002", "Honoraires experts", Some("613"), AccountType::Expense, true),
        ("613003", "Honoraires comptables", Some("613"), AccountType::Expense, true),
        ("613004", "Honoraires avocats", Some("613"), AccountType::Expense, true),

        ("614", "Publicité et propagande", Some("61"), AccountType::Expense, true),

        ("615", "Assurances", Some("61"), AccountType::Expense, false),
        ("615001", "Assurance incendie immeuble", Some("615"), AccountType::Expense, true),
        ("615002", "Assurance responsabilité civile", Some("615"), AccountType::Expense, true),
        ("615003", "Assurance tous risques", Some("615"), AccountType::Expense, true),

        ("617", "Personnel intérimaire", Some("61"), AccountType::Expense, true),

        ("618", "Rémunérations, charges sociales et pensions", Some("61"), AccountType::Expense, false),
        ("618001", "Salaires personnel", Some("618"), AccountType::Expense, true),
        ("618002", "Charges sociales", Some("618"), AccountType::Expense, true),
        ("618003", "Assurances sociales", Some("618"), AccountType::Expense, true),

        ("619", "Autres charges d'exploitation", Some("61"), AccountType::Expense, false),
        ("619001", "Frais postaux", Some("619"), AccountType::Expense, true),
        ("619002", "Frais bancaires", Some("619"), AccountType::Expense, true),
        ("619003", "Taxes et impôts divers", Some("619"), AccountType::Expense, true),

        // Class 62: Depreciation
        ("62", "Amortissements, réductions de valeur", Some("6"), AccountType::Expense, false),
        ("620", "Dotations aux amortissements", Some("62"), AccountType::Expense, true),

        // Class 63: Provisions
        ("63", "Provisions pour risques et charges", Some("6"), AccountType::Expense, false),
        ("630", "Dotations aux provisions", Some("63"), AccountType::Expense, true),

        // Class 64-65: Financial expenses & Other
        ("64", "Autres charges d'exploitation", Some("6"), AccountType::Expense, true),
        ("65", "Charges financières", Some("6"), AccountType::Expense, false),
        ("650", "Charges des dettes", Some("65"), AccountType::Expense, true),
        ("651", "Réductions de valeur sur actifs circulants", Some("65"), AccountType::Expense, true),

        // Class 66-67: Exceptional & Tax expenses
        ("66", "Charges exceptionnelles", Some("6"), AccountType::Expense, true),
        ("67", "Impôts sur le résultat", Some("6"), AccountType::Expense, true),
        ...
        ("70", "Chiffre d'affaires", Some("7"), AccountType::Revenue, false),
        ("700", "Appels de fonds copropriétaires", Some("70"), AccountType::Revenue, false),
        ("700001", "Appels de fonds ordinaires", Some("700"), AccountType::Revenue, true),
        ("700002", "Appels de fonds extraordinaires", Some("700"), AccountType::Revenue, true),
        ("700003", "Provisions mensuelles", Some("700"), AccountType::Revenue, true),

        // Class 74: Other operating revenue
        ("74", "Autres produits d'exploitation", Some("7"), AccountType::Revenue, false),
        ("740", "Subsides d'exploitation", Some("74"), AccountType::Revenue, true),
        ("743", "Indemnités perçues", Some("74"), AccountType::Revenue, true),
        ("744", "Récupération charges antérieures", Some("74"), AccountType::Revenue, true),

        // Class 75: Financial revenue
        ("75", "Produits financiers", Some("7"), AccountType::Revenue, false),
        ("750", "Produits des immobilisations financières", Some("75"), AccountType::Revenue, true),
        ("751", "Produits des actifs circulants", Some("75"), AccountType::Revenue, false),
        ("751001", "Intérêts compte bancaire", Some("751"), AccountType::Revenue, true),
        ("751002", "Intérêts compte épargne", Some("751"), AccountType::Revenue, true),

        // Class 76-77: Exceptional & Other revenue
        ("76", "Produits exceptionnels", Some("7"), AccountType::Revenue, true),
        ("77", "Régularisation d'impôts", Some("7"), AccountType::Revenue, true),

        // ====================================================================
        // CLASS 9: OFF-BALANCE (Memorandum accounts)
        // ====================================================================
        ("9", "Comptes hors bilan", None, AccountType::OffBalance, false),
        ("90", "Droits et engagements", Some("9"), AccountType::OffBalance, true),
    ]
}
...
mod tests {
    ...
    fn test_belgian_pcmn_seed_data_structure() {
        ...
        assert!(codes.contains(&"611002"), "Should have Elevator maintenance");
        assert!(codes.contains(&"615001"), "Should have Building insurance");
        assert!(codes.contains(&"700001"), "Should have Regular fees revenue");
    }
