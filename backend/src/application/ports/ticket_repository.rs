...
pub trait TicketRepository: Send + Sync {
    ...
    async fn find_by_status(&self, building_id: Uuid, status: TicketStatus) -> Result<Vec<Ticket>, String>;
    ...
    async fn count_by_status(&self, building_id: Uuid, status: TicketStatus) -> Result<i64, String>;
}
