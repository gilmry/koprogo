...
pub trait IndividualMemberRepository: Send + Sync {
    ...
    async fn find_by_campaign(&self, campaign_id: Uuid, page: i64, per_page: i64) -> Result<Vec<IndividualMember>, String>;
    async fn find_by_email(&self, email: &str) -> Result<Option<IndividualMember>, String>;
    async fn find_by_email_and_campaign(&self, email: &str, campaign_id: Uuid) -> Result<Option<IndividualMember>, String>;
    async fn find_active_by_campaign(&self, campaign_id: Uuid, page: i64, per_page: i64) -> Result<Vec<IndividualMember>, String>;
    async fn find_with_consent_by_campaign(&self, campaign_id: Uuid, page: i64, per_page: i64) -> Result<Vec<IndividualMember>, String>;
